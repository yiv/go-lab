...
func loadPublicKey(path string) (Unsigner, error) {
	x := `-----BEGIN PUBLIC KEY-----
cufDJKe2D75awwHRcAu9SthAx3UhMTdquCHUqhjohm+daeZL2b7tZTja+Y1WUN2J
nWVksPeEJQs8QOmWU0Cvb3m8bBpWrBFph+SfUY+rmkaZ+h51n1VPqZESKNwaDMON
HUU7Gi/e76lRe47HWHMXFXdo2IQbnlaK741tiCLl/Go=`
	y := `-----BEGIN PUBLIC KEY-----
